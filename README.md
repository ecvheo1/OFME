...
- Provider/Service: 비즈니스 로직 처리, 의미적 Validation, DB connection, transaction
...
│ 	│ 	│   ├── userProvider.js   		# R에 해당하는 서버 로직 처리, select 행위를 할 때
│ 	│ 	│   ├── userService.js   	  	# CUD에 해당하는 서버 로직 처리, insert updata delete 행위를 할 때
